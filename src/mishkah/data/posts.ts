...
export const posts: Post[] = [
  ...
  },
  {
    ...
    kind: 'congrats',
    body:
      'تهنئة من القلب للزميل محمد الشايع على إتمام مراجعة منهج التلاوة للمستوى الثاني قبل الموعد المحدد بأسبوع كامل. جهد يستحق الشكر والتقدير.',
    audience: { kind: 'center', label: 'لجميع موظفي المركز' },
    mentions: ['emp-01'],
    reactions: { '👏': 21, '🤍': 9, '👍': 5 },
    comments: [
  ...
  },
  {
    ...
    createdAt: daysAgo(5),
    kind: 'congrats',
    body: 'نرحّب بالزميلين عبدالله العبدالجبار وتميم القباطي المنضمّين حديثًا لأسرة المركز. نسأل الله لهما التوفيق.',
    audience: { kind: 'center', label: 'لجميع موظفي المركز' },
    mentions: ['emp-08', 'emp-09'],
    reactions: { '🤍': 19, '👏': 7 },
    comments: [{ id: 'c-08', authorId: 'emp-08', at: daysAgo(4.8), body: 'شكرًا لكم، سعيد بالانضمام إليكم.' }],
    saved: false,
  },
  {
    id: 'post-10',
